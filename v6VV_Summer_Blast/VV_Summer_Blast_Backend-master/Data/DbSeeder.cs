    ...
    public static void Seed(AppDbContext context)
    {
        ...
        if (!context.Eloadok.Any())
        {
            context.Eloadok.AddRange(new List<Eloado> {
                ...
                new Eloado { Id = 3, Nev = "Krébi", Leiras = "Magyar rapper ironikus szövegekkel", KepUrl = "https://s.24.hu/app/uploads/2025/01/central-0797651545-e1735920033192-1024x576.jpg", Mufaj = "rap", Bio = "Krébi a kortárs magyar popkultúra egyik legmeghatározóbb elõadója.", SpotifyUrl = "https://open.spotify.com/artist/6u7q0ZGK0oilVYx4kqIk3E" },
                ...
                new Eloado { Id = 15, Nev = "Dzsúdló", Leiras = "Modern pop elõadó", KepUrl = "https://i.scdn.co/image/ab6761610000e5eb20f975578f5643d0e524766b", Mufaj = "pop", Bio = "A kortárs magyar pop-trap szcéna egyik legmeghatározóbb alakja.", SpotifyUrl = "https://open.spotify.com/artist/3PMRY3PR5xAe5UpRfPPuaG" },
        ...
        // 5. TERMÉKEK (Merch + Teljes Jegy/Bérlet kínálat, immár Készlettel kiegészítve)
