...
namespace VVSummerBlastFRONTEND.Pages.Hostel
{
    public class IndexModel : PageModel
    {
        private readonly SzallasApi _szallasApi;
        public List<HostelDto> Hostelek { get; set; } = new();
        ...
        public async Task OnGetAsync()
        {
            try
            {
                Hostelek = await _szallasApi.GetHostelekAsync();
            }
            catch
            {
                Hostelek = new List<HostelDto>();
            }
        }
    }
}
